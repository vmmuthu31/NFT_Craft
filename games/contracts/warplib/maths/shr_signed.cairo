...
func warp_shr_signed8{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed16{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed24{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed32{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed40{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed48{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed56{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed64{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed72{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed80{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed88{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed96{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed104{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed112{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed120{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed128{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed136{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed144{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed152{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed160{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed168{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed176{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed184{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed192{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed200{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed208{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed216{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
...
func warp_shr_signed224{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
    let (local lhs_msb) = bitwise_and(
...
func warp_shr_signed232{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
    let (local lhs_msb) = bitwise_and(
...
func warp_shr_signed240{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
    let (local lhs_msb) = bitwise_and(
...
func warp_shr_signed248{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    alloc_locals;
    let (local lhs_msb) = bitwise_and(
...
func warp_shr_signed256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: Uint256, rhs: felt) -> (
    res: Uint256
) {
    alloc_locals;
...
func warp_shr_signed256_256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
