...
func warp_exp_unsafe8{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe8{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
...
func warp_exp_unsafe16{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe16{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe24{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe24{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe32{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe32{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe40{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe40{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe48{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe48{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe56{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe56{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe64{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe64{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe72{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe72{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe80{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe80{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe88{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe88{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe96{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe96{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe104{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe104{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe112{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe112{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe120{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe120{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe128{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe128{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe136{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe136{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe144{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe144{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe152{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe152{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe160{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe160{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe168{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe168{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe176{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe176{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe184{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe184{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe192{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe192{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe200{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe200{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe208{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe208{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe216{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe216{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe224{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe224{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe232{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe232{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe240{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe240{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe248{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (
    res: felt
) {
    if (rhs == 0) {
        return (1,);
...
func warp_exp_wide_unsafe248{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    lhs: felt, rhs: Uint256
) -> (res: felt) {
    if (rhs.low == 0) {
        if (rhs.high == 0) {
...
func warp_exp_unsafe256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(lhs: Uint256, rhs: felt) -> (
    res: Uint256
) {
    if (rhs == 0) {
        return (Uint256(1, 0),);
...
func warp_exp_wide_unsafe256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
