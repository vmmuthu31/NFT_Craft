...
func warp_int128_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffffffffffffffff)
        );
        return (res,);
    }
}
...
func warp_int136_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffffffffffffff00)
        );
        return (res,);
    }
}
...
func warp_int144_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffffffffffff0000)
        );
        return (res,);
    }
}
...
func warp_int152_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffffffffff000000)
        );
        return (res,);
    }
}
...
func warp_int160_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffffffff00000000)
        );
        return (res,);
    }
}
...
func warp_int168_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffffff0000000000)
        );
        return (res,);
    }
}
...
func warp_int176_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffffff000000000000)
        );
        return (res,);
    }
}
...
func warp_int184_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffffff00000000000000)
        );
        return (res,);
    }
}
...
func warp_int192_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffffff0000000000000000)
        );
        return (res,);
    }
}
...
func warp_int200_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffffff000000000000000000)
        );
        return (res,);
    }
}
...
func warp_int208_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffffff00000000000000000000)
        );
        return (res,);
    }
}
...
func warp_int216_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffffff0000000000000000000000)
        );
        return (res,);
    }
}
...
func warp_int224_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffffff000000000000000000000000)
        );
        return (res,);
    }
}
...
func warp_int232_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffffff00000000000000000000000000)
        );
        return (res,);
    }
}
...
func warp_int240_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xffff0000000000000000000000000000)
        );
        return (res,);
    }
}
...
func warp_int248_to_int256{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(op: felt) -> (
    ...
    if (msb == 0) {
        ...
        let (res, _) = uint256_add(
            naiveExtension, Uint256(0x0, 0xff000000000000000000000000000000)
        );
        return (res,);
    }
}
