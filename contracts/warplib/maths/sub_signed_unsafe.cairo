...
func warp_sub_signed_unsafe16{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe24{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe32{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe40{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe48{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe56{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe64{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe72{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe80{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe88{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe96{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe104{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe112{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe120{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe128{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe136{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe144{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe152{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe160{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe168{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe176{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe184{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe192{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe200{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe208{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe216{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
...
func warp_sub_signed_unsafe224{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
    let (left_msb: felt) = bitwise_and(
...
func warp_sub_signed_unsafe232{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
    let (left_msb: felt) = bitwise_and(
...
func warp_sub_signed_unsafe240{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
    let (left_msb: felt) = bitwise_and(
...
func warp_sub_signed_unsafe248{bitwise_ptr: BitwiseBuiltin*}(lhs: felt, rhs: felt) -> (res: felt) {
    // First sign extend both operands
    let (left_msb: felt) = bitwise_and(
